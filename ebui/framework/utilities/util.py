...
Most commonly used utilities should be implemented in this class
...
class Util(object):
    ...
    def getUniqueNameList(self, listSize=5, itemLength=None):
        ...
        Parameters:
            ...
            itemLength: It should be a list containing number of items equal
            to the listSize.This determines the length of the each
